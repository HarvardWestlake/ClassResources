...
(function () {
    ...
    ctx.imageSmoothingQuality = 'low'; // Better performance, still looks good
    ...
    // Keep tutorials card width in sync on resize
    ...
    // Redraw tutorial previews on resize when overlay is visible
    window.addEventListener('resize', () => {
